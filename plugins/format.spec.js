...
describe('plugins: format.embedResponsive()', () => {
  const src = {
  ...
  test('when including YouTube embed', () => {
  ...
  test('when including SoundCloud embed', () => {
